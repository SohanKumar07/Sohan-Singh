      ...
      <div className="hero-profile-row">
        ...
        <div className="hero-actions">
          <div className="hero-socials">
            <a href="https://github.com/SohanKumar07" target="_blank" rel="noreferrer" className="social-btn" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/sohankumar7/" target="_blank" rel="noreferrer" className="social-btn" aria-label="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
